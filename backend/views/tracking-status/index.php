...
?>
<div class="tracking-status-index">
    <div class="pt-3">
        <?php
        $defaultExportConfig = [
            GridView::EXCEL => [
...
//            'containerOptions' => ['style' => 'overflow: auto'], // only set when $responsive = false
            ...
            'toolbar' => [
                [
                    'content' => Html::button('<i class="fas fa-plus"></i> '.Yii::t('app','Add New Status'), [
                        'value' => Url::toRoute('tracking-status/create'),
                        'class' => 'btn btn-success',
                        'id' => 'modalTrackingStatusButton',
            ...
            'panel' => [
                ...
                'heading' => Yii::t('app','Order Status List'),
            ],
        ]);
        Pjax::end();
        ?>
        ...
        <script>
            $(document).ready(function () {
                $('.modal-category-content').load($('#modalTrackingStatusButton').attr('value'));
            });
        </script>
    </div>
</div>
