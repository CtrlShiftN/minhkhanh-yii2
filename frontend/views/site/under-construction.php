...
$this->title = Yii::t('app', 'MINHKHANH');
$this->registerCss("
    h1{
...
");
?>
<div class="site-under-constructione">
    <div class="warning-content">
        <h1><?= Yii::t('app','Under Construction') ?></h1>
        ...
        <p class="px-3">
            <?= Yii::t('app','Sorry for the inconvenience.') ?><br>
            <?= Yii::t('app','We are currently building our brand new website.') ?>

        </p>
        <a href="<?= Url::home() ?>" class="text-decoration-none fs-5 text-dark border-bottom border-dark fw-light"><- <?= Yii::t('app','Go back to homepage') ?></a>
    </div>
</div>