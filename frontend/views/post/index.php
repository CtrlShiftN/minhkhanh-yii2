...
<div class="posts row mt-4 w-100 px-0 mx-0">
    <div class="col-12 col-lg-8 col-xl-9 px-3 m-0">
        <h2 class="border-bottom border-danger border-2"><?= Yii::t('app', 'News') ?></h2>
        <?php if(!empty($post)): ?>
            ...
            ?>
        <?php else: ?>
            <div class="row mb-3 w-100 px-0 mx-0 d-flex align-items-center justify-content-center">
                <div class="text-center">
                    <img src="<?= Url::toRoute('img/news.png') ?>" class="objectfit-cover w-50"><br>
                    <h4><?= Yii::t('app','No news yet!') ?></h4>
                </div>
            </div>
        <?php endif; ?>
    </div>
